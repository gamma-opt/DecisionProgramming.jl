...
for N in N_max:-1:2
    ...
    result_arr[N-1,:] = [t1 objval-diagram.translation relative_gap(model)]
end

writedlm((@__DIR__)*"/results/pigfarm_lazy_"*string(idx)*".csv", result_arr, ',')
