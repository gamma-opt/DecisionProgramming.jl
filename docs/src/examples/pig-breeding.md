...
We apply an affine transformation to the utility function, making all path utilities positive. Since we are using this postive utility function, the probability cut can be excluded from the model. The purpose of this is discussed in the [theoretical section](../decision-programming/decision-model.md) of this documentation. 
