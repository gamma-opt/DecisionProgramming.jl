...
In this example, we will showcase the solution to the subproblem that determines the optimal decision strategy for a single prior risk level. The chosen risk level in this example is 12%. The solution to the main problem is found in [^1].
